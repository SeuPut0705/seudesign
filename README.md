...
skills/sdp/
  ...
  references/
    ...
    consensus.md              # quorum, Raft, linearizability, leases + fencing
    ...
    cases/                    # 5 worked designs
      ...
      payment-system.md       #   idempotency end-to-end, double-entry ledger
      kv-store.md             #   consistent hashing, quorum, hinted handoff
      collaborative-editing.md#   OT vs CRDT, op log + snapshots
      metrics-monitoring.md   #   cardinality, pull vs push, downsampling
